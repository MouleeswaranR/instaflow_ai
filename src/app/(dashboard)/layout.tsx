  ...
  return (
    <div className="flex h-full flex-col">
      ...
      <div className="border-t p-3">
        <div className={cn("flex items-center gap-3 rounded-lg px-3 py-2", collapsed && "justify-center px-0 flex-col")}>
          ...
          <div className={cn("flex items-center gap-1 shrink-0", collapsed ? "flex-col mt-2" : "ml-auto")}>
            <ThemeToggle />
            <Button
              variant="ghost"
              size="icon"
